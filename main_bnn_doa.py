...
train_dataset = TensorDataset(tensor_x[:8000], tensor_y[:8000])  # create your datset
test_dataset = TensorDataset(tensor_x[8000:], tensor_y[8000:])  # create your datset
...
class Net(nn.Module):
    def __init__(self):
        ...
        self.infl_ratio = 3
        self.fc1 = BinarizeLinear(2 * 64**2, 2048 * self.infl_ratio)
